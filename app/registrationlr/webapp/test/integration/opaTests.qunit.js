...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "registrationlr/test/integration/FirstJourney",
    "registrationlr/test/integration/VendorDetailsListJourney",
    "registrationlr/test/integration/VendorDetailsObjectPageJourney",
    "registrationlr/test/integration/MaterialDetailsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
